...
declare module "cloudinary-react" {
  ...
  export interface CommonTransformationOptions {
    ...
    custom_function?:
      | string
      | { function_type: string | "wasm" | "remote"; source: string };
  ...
  export interface ImageTransformationOptions
    extends CommonTransformationOptions {
    underlay?: string;
    color?: string;
  ...
  type ImageTransformationAndTagsOptions =
    | ImageTransformationOptions
    | ImageTagOptions;
  type VideoTransformationAndTagsOptions =
    | VideoTransformationOptions
    | VideoTagOptions;
  ...
  export namespace v2 {
    ...
    namespace api {
      ...
      function update_upload_preset(
        ...
        options?:
          | AdminApiOptions
          | { unsigned?: boolean; disallow_public_id?: boolean },
        callback?: ResponseCallback,
      ): Promise<unknown>;
      ...
      function upload_mappings(
        options?:
          | AdminApiOptions
          | { max_results?: number; next_cursor?: string },
        callback?: ResponseCallback,
      ): Promise<unknown>;
