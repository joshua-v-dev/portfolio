...
const HomeHero = () => {
  const textRef = useEntrance<HTMLDivElement>({ delay: 200, duration: 800 });

  return (
    <section className="z-100 relative mx-auto flex min-h-screen max-w-md flex-col items-center justify-start overflow-hidden bg-transparent pt-5 lg:max-w-6xl lg:flex-1">
      <HeroScene />
