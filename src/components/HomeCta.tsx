                ...
                <div className="mx-auto flex rounded-md shadow lg:gap-x-4">
                  <Link
                    ...
                    className="grid grid-flow-col-dense justify-end rounded-3xl border-2 border-t-2
                     ...
                     shadow-indigo-600 outline-2 outline-offset-2 outline-black brightness-125
                      backdrop-blur-sm transition duration-150 ease-in-out hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700
