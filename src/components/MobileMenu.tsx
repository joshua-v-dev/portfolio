    ...
    <nav className={"absolute h-full w-full  "}>
      <button
        className={cn(
          ...
          {
            "transition-opacity duration-300 ease-linear border-0 bg-accent-1 w-10 h-10 relative z-20 focus:outline-none": true,
          },
          "visible md:hidden",
        )}
      ...
      {isMenuMounted && (
        <ul
          className={cn(
            {
              "p-0 pl-1 pt-3 w-screen h-screen z-10 opacity-0 absolute left-0 transition-transform duration-300 ease-linear bg-gradient-to-t from-blue-400 to-blue-900": true,
            },
            ...
            isMenuRendered && {
              "opacity-100 translate-x-0 transform ": true,
            },
          )}
        >
          <li
          ...
          >
            <Link href="/products" onClick={closeMenu} className="flex w-auto ">
              Products
            </Link>
          </li>
          <li
          ...
          >
            <Link href="/services" onClick={closeMenu} className="flex w-auto ">
              Services
            </Link>
          </li>
          <li
          ...
          >
            <Link href="/contract" onClick={closeMenu} className="flex w-auto">
              Contract
            </Link>
          </li>
          <li
          ...
          >
            <Link href="/gallery" onClick={closeMenu} className="flex w-auto ">
              Gallery
            </Link>
          </li>
          <li
